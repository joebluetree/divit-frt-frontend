...
//Remark : all data variable used in Report Air Volume
//version : v1 - 16/01/2026

export interface iAirVolume {
  mbl_id: number;
  mbl_hbl_id: number;
  mbl_cfno: number;
  mbl_mode: string;
...
export interface iAirVolume_Search {
...
export interface iAirVolumeModel {
  selected_row_id: number;
  records: iAirVolume[],
  errorMessage: string,
  searchRecord: iAirVolume_Search,
  pageRecord: iPage,
  sort_column: string;
  sort_order: string;
};
