...
export interface iConsigneeShipment {
  hbl_id: number;
  hbl_mbl_id: number;
  hbl_cfno: number;
  hbl_mode: string;
...
export interface iConsigneeShipment_Search {
...
export interface iConsigneeShipmentModel {
  selected_row_id: number;
  records: iConsigneeShipment[],
  errorMessage: string,
  searchRecord: iConsigneeShipment_Search,
  pageRecord: iPage,
  sort_column: string;
  sort_order: string;
};
