  ...
  buildTable() {
    ...
    if (this.mbl_list_format == "F2") {
      this.table_data = [
        ...
        { col_name: "mbl_isf_no", col_caption: "ISF", col_format: "", col_sortable: true, col_link: '', col_param: {}, col_show: this.IsSeaImp },
        ...
        { col_name: "mbl_custom_reles_status", col_caption: "CUSTOM RELEASE STATUS", col_format: "", col_sortable: true, col_link: '', col_param: {}, col_show: this.IsSeaImp || this.IsAirImp },
    ...
    if (this.mbl_list_format == "F3") {
      this.table_data = [
        ...
        { col_name: "mbl_consignee_name", col_caption: "CONSIGNEE", col_format: "", col_sortable: true, col_link: '', col_param: {}, col_show: true },
        { col_name: "mbl_cntr_type", col_caption: "TYPE", col_format: "", col_sortable: true, col_link: '', col_param: {}, col_show: true },
        { col_name: "mbl_place_final", col_caption: "FINAL DESTINATION", col_format: "", col_sortable: true, col_link: '', col_param: {}, col_show: true },
        { col_name: "mbl_pol_etd", col_caption: "ETD", col_format: "date", col_sortable: true, col_link: '', col_param: {}, col_show: true },
