...
import { iSeaVolume_Search } from '../../models/iseavolume';

@Component({
  selector: 'app-seavolume-search',
  templateUrl: './seavolume-search.component.html',
  styleUrls: ['./seavolume-search.component.css'],
  standalone: true,
...
//Remark : this component manages searching of Sea Volume Report records

export class SeaVolumeSearchComponent {

  mform: FormGroup;
  record!: iSeaVolume_Search;

  @Input() print: boolean = false;
  @Input() IsDetail: boolean = false;
  @Input('search_url') search_url = '';

  @Input('input') set input(v: iSeaVolume_Search) {
    this.record = { ...v };
  }
  ...
  ngOnInit(): void {
    this.mform.setValue({
      ...
      mbl_cntr_type: this.record.mbl_cntr_type == '' ? "ALL" : this.record.mbl_cntr_type,
  ...
  search(_action: string) {
    if (this.output) {
      ...
      this.record.mbl_cntr_type = this.mform.value.mbl_cntr_type;
