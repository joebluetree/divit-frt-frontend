...
export class SeaImportmEditComponent extends baseEditComponent {
  ...
  callBack(action: any) {
    ...
    if (action.id == 'mbl_coloader_name') {
      if (action.rec == null) {
        this.mform.patchValue({
          mbl_coloader_id: null,
          mbl_coloader_name: '',
        });
      } else {
        this.mform.patchValue({
          mbl_coloader_id: action.rec.cust_id,
          mbl_coloader_name: action.rec.cust_name,
        });
      }
    }
    ...
    if (action.id == 'mbl_frt_status_name') {
      if (action.rec == null) {
        this.mform.patchValue({
          mbl_frt_status_id: null,
          mbl_frt_status_name: '',
        });
      } else {
        this.mform.patchValue({
          mbl_frt_status_id: action.rec.param_id,
          mbl_frt_status_name: action.rec.param_name,
        });
      }
    }
    ...
    if (action.id == 'mbl_ship_term_name') {
      if (action.rec == null) {
        this.mform.patchValue({
          mbl_ship_term_id: null,
          mbl_ship_term_name: '',
        });
      } else {
        this.mform.patchValue({
          mbl_ship_term_id: action.rec.param_id,
          mbl_ship_term_name: action.rec.param_name,
        });
      }
    }
    ...
    if (action.id == 'mbl_incoterm_name') {
      if (action.rec == null) {
        this.mform.patchValue({
          mbl_incoterm_id: null,
          mbl_incoterm_name: '',
        });
      } else {
        this.mform.patchValue({
          mbl_incoterm_id: action.rec.param_id,
          mbl_incoterm_name: action.rec.param_name,
        });
      }
    }
    ...
    if (action.id == 'mbl_status_name') {
      if (action.rec == null) {
        ...
        this.mform.patchValue({
          mbl_status_id: action.rec.param_id,
          mbl_status_name: action.rec.param_name,
        });
      }
    }
    ...
    if (action.id == 'mbl_vessel_code') {
      if (action.rec == null) {
        ...
        this.mform.patchValue({
          mbl_vessel_id: action.rec.param_id,
          mbl_vessel_code: action.rec.param_code,
          mbl_vessel_name: action.rec.param_name,
        });
      }
    }
    ...
    if (action.id == 'mbl_cargo_loc_code') {
      if (action.rec == null) {
        ...
        this.mform.patchValue({
          ...
          mbl_cargo_loc_add4: this.gs.getTelFax(action.rec),
        });
      }
    }
    ...
    if (action.id == 'mbl_devan_loc_code') {
      if (action.rec == null) {
        ...
        this.mform.patchValue({
          mbl_devan_loc_id: action.rec.cust_id,
          mbl_devan_loc_code: action.rec.cust_code,
          mbl_devan_loc_name: action.rec.cust_name,
          mbl_devan_loc_add1: action.rec.cust_address1,
          mbl_devan_loc_add2: action.rec.cust_address2,
          mbl_devan_loc_add3: action.rec.cust_address3,
          mbl_devan_loc_add4: this.gs.getTelFax(action.rec),
        });
      }
    }
