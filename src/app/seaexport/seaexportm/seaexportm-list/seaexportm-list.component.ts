...
import { SeaExportmSearchComponent } from '../seaexportm-search/seaexportm-search.component';

@Component({
  selector: 'app-seaexportm-list',
  templateUrl: './seaexportm-list.component.html',
  styleUrls: ['./seaexportm-list.component.css'],
  standalone: true,
  imports: [...CustomControls, SeaExportmSearchComponent],
})
...
export class SeaExportListComponent extends baseListComponent {

    

  constructor(public ms: SeaExportmService) {
    super(ms);
  }
  ...
  ngOnInit(): void {
    ...
    this.table_data = [
      { col_name: "edit", col_caption: "EDIT", col_format: "edit", col_sortable: false, col_link: '/seaexport/seaexportmEdit', col_param: param, col_show: this.bEdit || this.bView },
