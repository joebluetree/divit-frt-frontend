...
import { AirExportSearchComponent } from '../airexport-search/airexport-search.component';
import { AirExportService } from '../../services/airexport.service';

@Component({
  selector: 'app-airexport-list',
  templateUrl: './airexport-list.component.html',
  styleUrls: ['./airexport-list.component.css'],
  standalone: true,
  imports: [...CustomControls, AirExportSearchComponent]
})
