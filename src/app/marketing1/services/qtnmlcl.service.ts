...
export class QtnmLclService extends baseService {
  ...
  setInitialState() {
    return <iQtnm_lclModel>{
      selected_row_id: -1,
      records: [],
      searchRecord: <iQtnm_lcl_Search>{ title: this.title, qtnm_type:'', qtnm_from_date:'',qtnm_to_date:'', qtnm_no: '', qtnm_to_name: '',qtnm_pld_name: '', rec_company_id: 0,rec_branch_id: 0},
