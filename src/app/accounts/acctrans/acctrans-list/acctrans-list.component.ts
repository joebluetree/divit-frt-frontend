...
export class acctransListComponent extends baseListComponent {
  ...
  ngOnInit(): void {
    ...
    this.table_data = [
      ...
      { col_name: "jvh_year", col_caption: "FIN-YEAR", col_format: "", col_sortable: true, col_link: '', col_param: {}, col_show: true },
      { col_name: "jvh_shipment_ref", col_caption: "REF #", col_format: "", col_sortable: true, col_link: '', col_param: {}, col_show: true },
      { col_name: "jvh_shipment_date", col_caption: "REF-DT", col_format: "date", col_sortable: true, col_link: '', col_param: {}, col_show: true },
      { col_name: "jvh_debit", col_caption: "AMOUNT", col_format: "", col_sortable: true, col_link: '', col_param: {}, col_show: true },//debit or credit ( since here both are always same)
      { col_name: "jvh_narration", col_caption: "NARRATION", col_format: "", col_sortable: true, col_link: '', col_param: {}, col_show: true },
