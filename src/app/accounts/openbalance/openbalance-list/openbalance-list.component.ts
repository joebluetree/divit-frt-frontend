...
export class OpenBalanceListComponent extends baseListComponent {
  ...
  ngOnInit(): void {
    ...
    this.table_data = [
      ...
      { col_name: "jv_year", col_caption: "FIN-YEAR", col_format: "", col_sortable: true, col_link: '', col_param: {}, col_show: true },
      ...
      { col_name: "jv_narration", col_caption: "NARRATION", col_format: "", col_sortable: true, col_link: '', col_param: {}, col_show: true },
