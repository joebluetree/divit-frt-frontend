...
@Component({
  selector: 'app-profitreport-edit',
  templateUrl: './profitreport-edit.component.html',
  styleUrls: ['./profitreport-edit.component.css'],
  standalone: true,
  imports: [...CustomControls]
})
export class ProfitReportEditComponent extends baseEditComponent {
