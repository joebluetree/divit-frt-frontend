...
export class MessengerSlipListComponent extends baseListComponent {
  ...
  ngOnInit(): void {
    ...
    this.table_data = [
      { col_name: "edit", col_caption: "EDIT", col_format: "edit", col_sortable: false, col_link: '/common-shipment/messengerslipEdit', col_param: param, col_show: true },
      { col_name: "cs_id", col_caption: "ID", col_format: "", col_sortable: true, col_link: '', col_param: {}, col_show: true },
      { col_name: "cs_mbl_id", col_caption: "MASTER ID", col_format: "", col_sortable: true, col_link: '', col_param: {}, col_show: true },
      { col_name: "cs_refno", col_caption: "REF#", col_format: "", col_sortable: true, col_link: '', col_param: {}, col_show: true },
      { col_name: "cs_to_name", col_caption: "ASSIGNED", col_format: "", col_sortable: true, col_link: '', col_param: {}, col_show: true },
